...
public class EmpleadoActualizado extends DomainEvent {
    ...
    public EmpleadoActualizado(EmpleadoID entityId, Nombre nombre, NumeroCelular numeroCelular, Direccion direccion, Rol rol) {
        super("concesionarios.concesionario.empleadoactualizado");
