...
public class MotoActualizada extends DomainEvent {
    ...
    public MotoActualizada(Placa placa, Nombre nombre, Marca marca, Modelo modelo, Cilindraje cilindraje, Valor valor) {
        super("concesionarios.concesionario.motoactualizada");
        this.placa = placa;
        this.nombre = nombre;
        this.marca = marca;
        this.modelo = modelo;
